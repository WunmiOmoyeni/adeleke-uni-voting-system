...
import { collection, getDocs, addDoc, query, where, getDocs as getDocsAgain } from 'firebase/firestore';
...
const VotingPage = () => {
  ...
  const studentId = "student123"; // Replace with actual auth logic
  ...
  useEffect(() => {
    ...
    const fetchCandidates = async () => {
      try {
        ...
        const uniquePositions = [...new Set(candidateList.map((c) => c.position))];
  ...
  const handleSubmitVote = async () => {
    ...
    const hasEmptySelections = Object.values(selections).some(selection => selection === "");
    if (hasEmptySelections) {
      setError("Please make a selection for all positions before submitting your vote.");
      return;
    }
      ...
      <div className="container mx-auto p-6">
        ...
        {hasVoted && !successMessage && (
          <div className="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mb-6">
            <p className="font-bold">You have already voted in this election.</p>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-8">
          <h2 className="text-xl font-semibold text-blue-800 mb-3">Voting Instructions</h2>
          <ul className="list-disc pl-5 text-gray-600 space-y-2">
            ...
            <li>You can click on "View Profile" to learn more about a candidate before voting</li>
          </ul>
        </div>
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <div className="text-gray-600">
                {selections[position] ? (
                  ...
                  <span className="text-orange-500 font-medium">Selection required</span>
                )}
              </div>
            </div>
                  ...
                  >
                    ...
                    <div className="p-5">
                      ...
                      <div className="flex flex-col sm:flex-row gap-2 mt-3">
                        ...
                        >
                          {selections[position] === candidate.id ? 'Selected' : 'Select'}
                        </button>
                      </div>
                    </div>
                  </div>
